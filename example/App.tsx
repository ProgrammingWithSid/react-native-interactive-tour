...
import { TourProvider, TourTarget, useTour, type TourStep } from 'react-native-onboarding-tour'
    ...
    return screen === 'home' ? (
        <View style={styles.screen}>
            <TourTarget id='home.title'>
                <Text style={styles.title}>react-native-onboarding-tour example</Text>
            </TourTarget>
