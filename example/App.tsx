...
import { TourProvider, TourTarget, useTour, type TourStep } from 'react-native-interactive-tour'
    ...
    return screen === 'home' ? (
        <View style={styles.screen}>
            <TourTarget id='home.title'>
                <Text style={styles.title}>react-native-interactive-tour example</Text>
            </TourTarget>
